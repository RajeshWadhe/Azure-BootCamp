...
$dnsName    = "demodnsrajesh"  
$saName     = "saamaday2rgdiag"
...
$rgName     = "SaamaDay2-rg"   
$rgVNETName = "SaamaDay2-rg"
$VNETName = "SaamaDay2-rg-vnet" 
...
# Create a new network interface in the Data subnet .Subnets[0].Id
$nic = New-AzureRmNetworkInterface -Name $nicName `
                                 -ResourceGroupName $rgName `
                                 -Location $location `
                                 -SubnetId $vnet.Subnets[0].Id
